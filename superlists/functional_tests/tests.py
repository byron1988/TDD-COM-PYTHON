...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_and_retrieve_it_later(self):
        # Edith ouviu falar de uma nova aplicação online intessante
        ...
        # Ela é convidada a inserir um item de tarefa imendiatamente
        ...
        # Quando ela tecla ente, a página é atualizada, e agora a página lista
        ...
        # Edith se pergunta se o site lembrará de sua lista. Entãi ela nota
    ...
    def test_can_start_a_list_for_one_user(self):
        ...
        # Safisteita, ela voltar a dormir

    def test_multiple_users_can_lists_at_diferent_urls(self):
        ...
        # Ela percebe que sua lista tem URL único
